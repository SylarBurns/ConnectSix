class checkSix {
	...
	public int checkrow(){
		...
		if(Gomoku.board[(n*19)+i].BW!=N)
		{
			...
			if(Gomoku.board[((n*19)+i)+0]==B) blackNum++;
			else if(Gomoku.board[((n*19)+i)+0]==W) whiteNum++;
			else notNum++;
			if(Gomoku.board[((n*19)+i)+1]==B) blackNum++;
			else if(Gomoku.board[((n*19)+i)+1]==W) whiteNum++;
			else notNum++;
			if(Gomoku.board[((n*19)+i)+2]==B) blackNum++;
			else if(Gomoku.board[((n*19)+i)+2]==W) whiteNum++;
			else notNum++;
			if(Gomoku.board[((n*19)+i)+3]==B) blackNum++;
			else if(Gomoku.board[((n*19)+i)+3]==W) whiteNum++;
			else notNum++;
			if(Gomoku.board[((n*19)+i)+4]==B) blackNum++;
			else if(Gomoku.board[((n*19)+i)+4]==W) whiteNum++;
			else notNum++;
			if(Gomoku.board[((n*19)+i)+5]==B) blackNum++;
			else if(Gomoku.board[((n*19)+i)+5]==W) whiteNum++;
			else notNum++;
